...
- scene: Kinetic type on clean light canvas. Three escalating beats land solo: "You read every page." / "All fourteen of them." / "But did you understand it?" The word "understand" swaps to error-red and holds.
- duration: 7s
- transition_in: cut
- status: outline
